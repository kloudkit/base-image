...
[![Docker](https://img.shields.io/badge/v0.0.7-a?style=for-the-badge&logo=docker&logoColor=c6d0f5&label=docker&labelColor=414559&color=ef9f76)](https://github.com/kloudkit/base-image/pkgs/container/base-image)
...
| `v0.0.7`          | 12 *(Bookworm)* | Versioned stable release (latest)      |
| `v0.0`            | 12 *(Bookworm)* | Major.minor versioned release (latest) |
| `v0.0.7-bookworm` | 12 *(Bookworm)* | Versioned Bookworm variant             |
| `v0.0.7-trixie`   | 13 *(Trixie)*   | Versioned Trixie variant               |
